      ...
      <div className="mb-6">
        ...
        <div className="mb-4">
          <button
            onClick={scanProject}
            disabled={isLoading}
            className="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors duration-300 disabled:bg-blue-400 font-medium flex items-center shadow-sm"
          >
            {isLoading ? (
              <>
                <svg
        ...
        {/* 视图切换按钮组 */}
        <div className="bg-gray-100 dark:bg-gray-800 p-2 rounded-lg inline-flex flex-wrap gap-2 shadow-sm">
          <button
            onClick={() => setShowComments(!showComments)}
            disabled={isLoading || !statistics}
            className={`px-4 py-2 rounded-md text-sm font-medium transition-colors duration-300 flex items-center gap-1.5
              ${
                showComments
